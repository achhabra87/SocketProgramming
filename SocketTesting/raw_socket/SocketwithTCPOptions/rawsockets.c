  ...
  while ((c = getopt(argc, argv, "S:D:N:P:F:a:Q:b:c:d:e:f:g:h:i:j:k:l:m:n:o:p:q:r:s:t:u:")) != -1) {
    ...
    case 'c':
      tcpopt->op1=atoi(optarg);
		printf("Field 2nd byte\n");
      break;
    case 'd':
      tcpopt->op2=atoi(optarg);
	  printf("Field 3nd byte\n");
      break;
    case 'e':
    ...
    case 'j':
      tcpopt->op8=atoi(optarg);
      break;
    case 'k':
      tcpopt->op9=atoi(optarg);
      break;
    case 'l':
      tcpopt->op10=atoi(optarg);
      break;
    case 'm':
      tcpopt->op11=atoi(optarg);
      break;
    case 'n':
      tcpopt->op12=atoi(optarg);
      break;
    case 'o':
      tcpopt->op13=atoi(optarg);
      break;
    case 'p':
      tcpopt->op14=atoi(optarg);
      break;
	
	case 'q':
      tcpopt->op15=atoi(optarg);
      break;
    case 'r':
      tcpopt->op16=atoi(optarg);
      break;
    case 's':
      tcpopt->op17=atoi(optarg);
		printf("s\n");
      break;

    case 't':
      tcpopt->op18=atoi(optarg);
		printf("t\n");
      break;

    case 'u':
      tcpopt->op19=atoi(optarg);
		printf("u\n");
