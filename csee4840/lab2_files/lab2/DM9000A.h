...
#define RCS    0x32  /*Recieve Checksun Register*/
#define TCS    0x31  /*Trasmit Checksun Register*/
#define RCS_set    0x01  /*Recieve Checksun Register*/
#define TCS_set    0xFF  /*Trasmit Checksun Register*/
