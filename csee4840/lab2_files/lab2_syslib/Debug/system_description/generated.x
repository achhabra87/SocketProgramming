 ...
 *
 * Generated: 2012-05-04 21:13:53.006
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x00900800, LENGTH = 32
    sdram_0_UNUSED : ORIGIN = 0x00000000, LENGTH = 32
    sdram_0 : ORIGIN = 0x00000020, LENGTH = 8388576
    cfi_flash_0 : ORIGIN = 0x00800000, LENGTH = 1048576
    sram_0 : ORIGIN = 0x00980000, LENGTH = 524288
    epcs_controller : ORIGIN = 0x00900820, LENGTH = 2016
}

    /* Define symbols for each memory base-address */
 __alt_mem_sdram_0 = 0x00000000 ;
 __alt_mem_cfi_flash_0 = 0x00800000 ;
 __alt_mem_sram_0 = 0x00980000 ;
 __alt_mem_epcs_controller = 0x00900800 ;
...
PROVIDE( __alt_heap_limit    = 0x00a00000 );
