...
int main()
{
    ...
    int globalPacket = 1;
    int orderId = 0;
    unsigned char name[5][5] = {"amyn","micr","goog","msft","aple"};
    unsigned int price[5] = {100, 100, 100, 100, 100};
    unsigned int number[5] = {200, 200, 200, 200, 200};
    unsigned char buySell[] = { 0x00,0x01,0x00,0x01,0x00};
    int cc=0;
    // End market details
    int curMsgChar = 0;
    alt_u8 key = 0;
                    ...
                    switch (key) {
                        case  0x5a: /* enter key: send the msg */                            
                            ...
                            for(count=0;count<numberofPackets;count++)
                            {
                                ...
                                memcpy(UDP_PACKET_PAYLOAD+curMsgChar,name[count],4);
